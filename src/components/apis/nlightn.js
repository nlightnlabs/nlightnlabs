...
export const authenticateUser = async (params)=>{
  try{
    const submitLoggin = await dbUrl.post("/nlightn/db/authenticateUser",{params})
...
export const getUserInfo = async (params)=>{
  try{
    const getUserQuery = await dbUrl.post("/nlightn/db/userRecord",{params})
...
export const addUser = async (params)=>{
  ...
  try{
    const result = await dbUrl.post("/nlightn/db/addUser",{params})
    //console.log(result)
    const data = await result.data
    return (data)
  }catch(error){
